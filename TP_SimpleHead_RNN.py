...
Features:
- Simple, robust MLP head for RNN pre-training
- Strong regularization to prevent overfitting
- Focus on stable feature learning
"""
...
# ==============================================================================
# 1. Helpers: Encoder & Simple MLP Head
# ==============================================================================
...
class SimpleMLPHead(nn.Module):
    """
    Simple, Robust MLP Head for Stable Feature Learning

    Philosophy:
    - No fancy attention/gating - just solid MLP
    - Heavy regularization (dropout + batch norm)
    - Residual connections for gradient flow
    - Focus on learning stable, generalizable features
    """
    def __init__(self, input_dim, hidden_dim=32, dropout=0.4):
        super(SimpleMLPHead, self).__init__()
...
def train_rnn_extractor(model, train_loader, val_loader, criterion, optimizer, epochs=50):
    ...
    # Pre-train using [RNN + Static] -> Simple MLP Head
    temp_head = SimpleMLPHead(
...
def main():
    ...
    print("Using Simple MLP Head for Robust Training")
    print("="*80)
    ...
    plt.tight_layout()
    plt.savefig("result/simple_head_tabpfn_vs_baseline.png", dpi=300)
    print("\nPlot saved to result/simple_head_tabpfn_vs_baseline.png")
