"""
END-TO-END TRAINING: RNN -> [RNN + Last + Static] -> TabPFN (frozen)

Key Innovation:
- NO mimic head - train RNN directly with TabPFN in the loop
- TabPFN is frozen but provides gradients for RNN training
- RNN learns to produce features that maximize TabPFN's performance
"""
